...
Set service runtime paths in your shell or a private env file outside this checkout. `.env.example` shows the
expected variables and keeps all credentials as placeholders.
